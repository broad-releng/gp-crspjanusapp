 ...
 */
public class TruSeqSpikeController  extends PlateTransferEventController {
    private static final Logger gLog = LoggerFactory.getLogger(TruSeqSpikeController.class);
