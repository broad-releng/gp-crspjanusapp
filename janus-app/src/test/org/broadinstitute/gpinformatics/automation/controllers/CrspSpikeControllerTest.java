...
public class CrspSpikeControllerTest {
    ...
    @Test
    public void testBuildCrspSpikeMessage() throws Exception {
        ...
        CrspSpikeController controller = new CrspSpikeController() {
            @Override
        ...
        controller.protocolType = ProtocolTypes.CrspSpike;
        ...
        assertEquals(ProtocolTypes.CrspSpike.getEventType(), daughterPlateEvent.getEventType());
        ...
        assertEquals(ProtocolTypes.CrspSpike.getEventType(), parentPlateEvent.getEventType());
    ...
    @Test
    public void testBuildCrspNormOnlyMessage() throws Exception {
        Rack daughterRack = new Rack();
