...
public class TruSeqAliquotControllerTest {
    ...
    public void testBuildTruSeqAliquotMessage() throws Exception {
        ...
        transfer.setTargetConcentration(26.66897);
        final List<WorklistRow> transfers = new ArrayList<>();
        transfers.add(transfer);

        TruSeqAliquotController controller = new TruSeqAliquotController() {
            @Override
        ...
        controller.protocolType = ProtocolTypes.TruSeqAliquot;
        ...
        Assert.assertEquals(
                ProtocolTypes.TruSeqAliquot.getEventType(), plateTransferEventType.getEventType());
        ...
        Assert.assertEquals("EB", reagentType.getKitType());
        ...
        Assert.assertEquals(BigDecimal.valueOf(2400, 2), sourceReceptacleType.getVolume());
        ...
        Assert.assertEquals(BigDecimal.valueOf(2667, 2), receptacleType.getConcentration());
