...
/**
 * Test volume addition controller
 */
public class VolumeAdditionControllerTest {
    @Test
    public void testBuildMessage() throws Exception {
        ...
        double target = 80;
        Normalization transfer = new Normalization(false, false);
        transfer.setWell("A1");
        ...
        Normalization transfer2 = new Normalization(false, false);
        transfer2.setWell("A2");
        transfer2.setBarcode("srctube02");
        transfer2.setV1(100);
        transfer2.setC1(50);
        transfer2.setTarget(target);

        RaiseVolumeController controller = new RaiseVolumeController() {
            @Override
        ...
        controller.protocolType = ProtocolTypes.RaiseVolume;
        ...
        Assert.assertEquals(
                ProtocolTypes.RaiseVolume.getEventType(), plateEventType.getEventType());
